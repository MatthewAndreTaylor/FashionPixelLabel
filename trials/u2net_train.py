...
# Adapted from https://github.com/xuebinqin/U-2-Net
...
tra_label_dir = os.path.join("labels/clothes" + os.sep)

image_ext = ".jpg"
label_ext = "_clothes.png"
...
salobj_dataloader = DataLoader(
    salobj_dataset, batch_size=batch_size_train, shuffle=True
)
